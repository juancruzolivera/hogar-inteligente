...
actual, el consumo promedio diario, la fecha de vencimiento si existe, y el saldo
disponible en el presupuesto de la categoria. Vos tomas la decision final: si el saldo
es bajo o no alcanza para el precio estimado, ajusta la cantidad sugerida a la baja (la
minima cantidad razonable) en vez de ignorar el saldo, pero la decision es tuya.
